...
const userLayout: Layouts  = 
      {
        lg: [
          ...
          { i: "ReminderWidget", x: 5, y: 1, w: 4, h: 1, isDraggable: true, isResizable: true },
          { i: "NotificationWidget", x: 0, y: 1, w: 4, h: 1, isDraggable: true, isResizable: true},
          { i: "ProgressWidget", x: 5, y: 4, w: 4, h: 1, isDraggable: true, isResizable: true},
