    ...
    <Card style={{display:'flex', flexDirection:'column', marginTop:'2rem'}}>
      ...
      <CardContent style={{display:'flex', justifyContent:'center', marginTop:'2rem'}}>
        ...
        <Box>
            ...
            <Typography variant="h3" className={classes.typoTitle} style={{paddingTop:'1rem'}}>{`${moment(dateOfWedding.toString()).format("dddd DD-MM-YYYY")} o godzinie ${moment(timeOfWedding.toString()).format("hh:mm A")}`}</Typography>
            <Timer/>
        </Box>
      </CardContent>
      </Collapse>
