...
const WeddingCalendar = () => {
  ...
  return (
    <Card style={{display:'flex', flexDirection:'column', margin:'3rem 8rem 5rem 3rem'}}>
      <Button onClick={()=>dispatch(addEvent.addEvent(event))} style={{margin:'2rem 0rem 1rem 2rem', width:'18rem', height:'3rem'}} variant="contained" startIcon={<AddCircleIcon />}>NOWE PRZYPOMNIENIE</Button>
