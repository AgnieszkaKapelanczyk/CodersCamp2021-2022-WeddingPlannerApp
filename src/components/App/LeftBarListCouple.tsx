...
{icon:<WomanOutlinedIcon/>, label:"Panna Młoda", path:'/WeddingCouple/Bride/'},
...
{icon:<AccountBalanceWalletOutlinedIcon/>, label:"Budżet", path:'/WeddingCouple/Spending/'},
...
export default LeftBarListCouple;