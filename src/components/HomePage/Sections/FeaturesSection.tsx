  ...
  return (
    <Box style={{ paddingBottom: '5vh' }}>
      <Box>
        ...
        <Divider
          component="li"
          style={{ width: '43vw', height: '0.6rem', backgroundColor: `${theme.palette.secondary.main}` }}
        />
      </Box>
      <Box style={{ display: 'flex', flexDirection: 'row', textTransform: 'uppercase' }}>
        <Box>
        ...
        <Box style={{ width: '30%', height: '30%', marginTop: '8%', marginLeft: '9vw' }}>
